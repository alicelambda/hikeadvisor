        ...
        >
            <Grid item>
                ...
                <Box textAlign="left" p={3} alignContent="center">
                  ...
                  <img className={classes.photo} src={"https://upload.wikimedia.org/wikipedia/commons/thumb/9/94/California_in_United_States.svg/2880px-California_in_United_States.svg.png"}/>
                  <img className={classes.photo} src={"https://upload.wikimedia.org/wikipedia/commons/thumb/0/01/Flag_of_California.svg/2560px-Flag_of_California.svg.png"}/>
                </Box>
            </Grid>
            <Divider/>
            <Grid item>
      ...
      <Box p={3} 
        ...
        <Typography variant="body1" component="h2" id="blurbtitle">
          ...
          Nickname: The Golden State<br/>
            ...
            Largest City: Los Angeles<br/>
            Population: 39,512,223 <br/>
            Pop. Density: 97.9 people per sq mile<br/>
