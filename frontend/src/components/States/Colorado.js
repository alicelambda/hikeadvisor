    ...
    <Paper >
      <Box p={3} 
        ...
        <Typography variant="h6" component="h2" id="blurbtitle">
                Trails:<br/>
                <Link to="/tails/7000130" style={{ textDecoration: 'none' }}>Bear Peak Out and Back</Link><br/>
                <Link to="/tails/7011192" style={{ textDecoration: 'none' }}>Boulder Skyline Traverse</Link><br/>
                <Link to="/tails/7004226" style={{ textDecoration: 'none' }}>Sunshine Lion's Lair Loop"</Link><br/>
              </Typography>
        <Typography variant="body1" component="h2" id="blurbtitle">
