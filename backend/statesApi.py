...
def getState():
    ...
    for i in range(0, len((lat_list))):
        ...
        try:
            ...
            basic_data = text_to_list(
                wf_jsonRes["queryresult"]["pods"][1]["subpods"][0]["img"]["alt"]
            )
            info_capital = basic_data[3]

            population_data = text_to_list(
                wf_jsonRes["queryresult"]["pods"][3]["subpods"][0]["img"]["alt"]
            )
            ...
            geographic_data = text_to_list(
                wf_jsonRes["queryresult"]["pods"][7]["subpods"][0]["img"]["alt"]
            )
            ...
            symbol_data = text_to_list(
                wf_jsonRes["queryresult"]["pods"][15]["subpods"][0]["img"]["alt"]
            )
