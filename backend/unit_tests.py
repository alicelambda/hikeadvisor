...
TRAIL_PROPERTIES = ['trail_ascent', 'trail_descent', 'trail_high', 'trail_id', 'trail_latitude', 'trail_length', 'trail_location', 'trail_longtitude', 'trail_low', 'trail_name', 'trail_numstars', 'trail_picURL', 'trail_stars', 'trail_states']
